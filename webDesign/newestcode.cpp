...
void buildWebpage() {
    ...
    // Variables
    html += "var titanicLat = 47.168900189313";
    html += "var titanicLong = -109.63099896919";
    html += "var timeArray = " + parseVector(timeV);
    html += "var accelData = [" + parseVector(accelX) + "," + parseVector(accelY) + "," + parseVector(accelZ) + "]";
    html += "var tempData = " + parseVector(timeV);
...
void loop() {
  ...
  timeV.push_back(std::time(nullptr))
